...
namespace GUI
{
    ...
    public class FolderPicker : INotifyPropertyChanged
    {
        ...
        {;
            owner = null;
            bool x = ShowDialog(IntPtr.Zero, throwOnError) ?? false;
            if (x)
            {
                PropertyChanged.Invoke(this, new PropertyChangedEventArgs("ResultPath"));
            }
